...
const Vetrina = () => {
  ...
  return (
    <div className="bg-bgColor md:pt-[53px] md:pl-[288px] md:pr-[46px] flex flex-col md:flex-row">
      <div className="flex flex-col pt-[59px] px-[22px] mb-[15px] md:pt-0 md:px-0 md:basis-1/3">
        <DragZone images={images} setImages={setImages} />
        <div className="hidden md:flex md:mt-[46px] items-center justify-center">
          <img src={BigPhoneIcon} alt="phone" className="w-[50%]" />
        </div>
      </div>

      <div className="flex flex-col px-[22px] mb-[60px] md:basis-2/3">
        ...
        <div className="mb-[40px]">
          <button
            className="w-full rounded-lg font-poppins font-bold text-bgColor text-[16px] leading-[24px] bg-customBlue pt-[16px] pb-[13px]"
